...
class LocalNotificationManagerImpl implements LocalNotificationManager {
  ...
  @override
  Future<void> scheduleDailyReminderNotification(SchedulableTime scheduledTime, String content, String payload) async {
  ...
  @override
  Future<void> scheduleReminderNotification(DateTime dateTime, String content, String payload) async {
    var androidPlatformChannelSpecifics = AndroidNotificationDetails(
  ...
  Future<void> cancelDailyReminderNotification() async {
    return await cancelNotification(dailyReminderNotificationId);
  }
